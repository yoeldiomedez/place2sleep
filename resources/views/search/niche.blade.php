...
@section('pagetitle', 'Consulta por Nicho')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-12">
                            <table id="dataTableInhumationN" class="table table-bordered table-hover">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $("#dataTableInhumationN").DataTable({
                language: {
                ...
                columns: [
                    ...
                    {data: null, render: function ( data, type, row ) {
                        return row.buriable.row_x +' - '+ row.buriable.col_y +' | '+ row.buriable.category
                    }},
